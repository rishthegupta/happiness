package src.com.capgemini.test;
...
public class WalletTest {
	...
	@Test(expected=src.com.capgemini.exception.MobileNumberAlreadyExistsException.class)
	...
	@Test(expected=src.com.capgemini.exception.FieldCannotBeNullException.class)
	...
	@Test(expected=src.com.capgemini.exception.PhoneNumberDoesNotExistException.class)
	...
	@Test(expected=src.com.capgemini.exception.InsufficientBalanceException.class)
	...
	public void WhenShowTransactionCalledItShouldReturnListContainingTransaction() throws InsufficientBalanceException, PhoneNumberDoesNotExistException, FieldCannotBeNullException, MobileNumberAlreadyExistsException
	{
		...
		assertEquals(4, walletService.showTransactions("9999999999").size());
	}
